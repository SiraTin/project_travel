      ...
      <swiper-slide className="relative text-white z-30 ">
        ...
        <div className="flex flex-col justify-between h-full p-8">
          <div className="relative lg:p-14">
            <h2 className="capitalize text-4xl font-bold xl:text-6xl font-playfairDisplay text-white">
              {travels.name},
              <span className="capitalize font-playfairDisplay text-white">{travels.district}</span>
            </h2>
            <h2 className="uppercase text-3xl font-bold mt-4 xl:text-6xl font-playfairDisplay text-white">{travels.city}</h2>
