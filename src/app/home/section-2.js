      ...
      <swiper-slide>
        ...
        >
            <div className="flex justify-end p-4">
                ...
                <h2 className="text-sm text-white">{city.rating}</h2>
                <FontAwesomeIcon icon={faStar} className="mt-0.5 text-sm text-white"/>
                </div>
            </div>
            <div className="p-10 ">
                <div className="bg-[rgba(0,0,0,0.5)] w-10/12 p-4 rounded-3xl">
                <h2 className="text-white">{city.name}, <span className="text-white">{city.district}</span></h2>
                <h2 className="my-1 uppercase text-white">{city.city}</h2>
